...
public class whisk3 extends android.app.Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.whisk3);
...
private class DragEventListener implements View.OnDragListener {
        ...
        switch (event.getAction()) {
            ...
            case DragEvent.ACTION_DROP:
                ...
                if ("whisk".equals(draggedTag)) {
                    // Correct item
                    Toast.makeText(whisk3.this, "Correct! Moving to the next step.", Toast.LENGTH_SHORT).show();
                    // Move to addbakingtin activity and clear previous activities
                    Intent intent = new Intent(whisk3.this, addbakingtin.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK); // Clear previous activities
                    startActivity(intent);
                    finish(); // Ensure whisk3 is removed from the stack
                    return true;
                } else {
                    // Incorrect item
                    wrongAttempts++;
                    Toast.makeText(whisk3.this, "This is not the right item. Try again.", Toast.LENGTH_SHORT).show();
    ...
    private void autoDropWhisk() {
        new Handler().postDelayed(() -> {
            ...
            Toast.makeText(whisk3.this, "Let me help you! Moving to the next step.", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(whisk3.this, addbakingtin.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK); // Clear previous activities
            startActivity(intent);
            finish(); // Ensure whisk3 is removed from the back stack
